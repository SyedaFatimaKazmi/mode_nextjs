...
// below part wont run till issues are recieved
  return (
    <div>
      ...
      {issues.length > 0 ? (
        <div className="overflow-hidden rounded-lg border border-gray-200 dark:border-dark-border-default  dark:bg-dark-high shadow-sm">
          {/* Header row */}
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center border border-gray-200 dark:border-dark-border-default rounded-lg dark:bg-dark-high p-8">
