...
// => the thing gives error since there are no <html> & <body> tags
...
// has to be default export for pages (to recognize it to be a route)
...
export default async function MarketingLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="border-b border-dark-border-subtle bg-dark-base">
      ...
      <footer className="border-b border-dark-border-subtle bg-dark-base">
