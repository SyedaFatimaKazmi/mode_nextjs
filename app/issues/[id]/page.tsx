...
export default async function IssuePage({
  ...
  const issue = await getIssue(parseInt(id)) // in db all ids are nunbers

  if (!issue) {
    notFound() // nextjs automatically make sthis notfound page for us, which we can override and make our own
  }
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <div className="dark:bg-dark-elevated border border-gray-200 dark:border-dark-border-default rounded-lg shadow-sm p-6 mb-8">
